...
namespace HqDownloadManager.Controller.ViewModel.HqStatus {
    public class HqStatusViewModel : ViewModelBase {
        ...
        public ReadStatus ReadStatus {
            get {
                return Enum.Parse<ReadStatus>(SelectedStatus);
            }
        }

        public Chapter LastChapterRead {
            get { return _lastChapterRead; }
            set { _lastChapterRead = value;
